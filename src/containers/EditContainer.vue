<template>
  <div>
    <h1>Edit address</h1>
    <form id="editContainer" @submit.prevent="updateAddressBook">
      <div class="row">
        <div class="col-md-6">
...
import { fetchAddressToEdit, updateAddressBook } from "./../utils";
...
export default {
  ...
  validations,
  async created() {
    const { firstName, lastName, email, phoneNumber, notes, dob } = await fetchAddressToEdit({ id: this.$route.params.id });
  ...
  methods: {
    updateAddressBook: async function() {
